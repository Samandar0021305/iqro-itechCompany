      ...
      <ul className="flex justify-between mt-5 sm:mt-8 flex-wrap gap-2 xsm:gap-3 xl:gap-6 ">
        {Services.map((postEl, id) => {
          return (
            <li
              key={id}
              className=" w-[120px] h-[100px] xsm:w-[140px] xsm:h-[115px]   sm:w-[190px] sm:h-[135px] md:w-[230px] md:h-[135px]   lg:w-[320px] lg:h-[200px] xl:w-[400px] xl:h-[250px]   flex mt-[20px] rounded bg-bluef"
            >
