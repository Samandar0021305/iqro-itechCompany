...
import {  design, ui } from "../../utils/Constants";
            ...
            <ul className="flex justify-center xsm:justify-between items-center flex-wrap gap-2 lg:gap-4 sm:mt-20">
              {design.map((post,id) => {
                return (
                  <li data-aos="zoom-in"
                    key={id}
                    className="bg-blue hover:shadow-xl transition-shadow flex flex-col gap-1 md:gap-2 pl-2 lg:pl-6 items-start justify-center text-[10px] sm:text-[12px] xl:text-[21px] lg:m-0 bg-opacity-20 rounded  w-[90px] h-20 md:w-28 md:h-24 lg:w-36 lg:h-32 xl:w-[190px] xl:h-[160px]"
                  >
                    <Image data-aos="zoom-in"
                      ...
                      alt=""
                    />
                    <div data-aos="zoom-in" className="font-medium">{post.text}</div>
                  </li>
                );
              })}
            </ul>
            <h2 data-aos="zoom-in" className=" text-xl xsm:text-2xl lg:text-3xl font-medium sm:font-semibold mt-10 lg:mt-16">
              {t("Technologies")}
            </h2>
              ...
              {ui.map((postEl, id) => {
                return (
                  <li key={id} >
                    ...
                    <p data-aos="zoom-in" className="text-center mt-1 text-[15px] md:text-[19px] lg:text-[21px] ">
                      {postEl.text}
                    </p>
                  </li>
                );
