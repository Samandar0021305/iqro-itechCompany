...
function DevelopmentMobile() {
  ...
  return (
    <div className="container  mx-auto py-5 sm:pb-0  pt-10   md:pt-14 md:pb-2">
      ...
      <div className=" bg-white sm:bg-opacity-20  lg:bg-opacity-20 mt-[50px] sm:mt-[0] sm:pb-[60px]">
        <div className="flex flex-col-reverse sm:flex-row justify-between gap-10 mx-auto">
          ...
          <div className="md:w-[50%] bg-no-repeat bg-cover bg-[url(https://media.tenor.com/LMpVMsVPmVEAAAAC/mobile-application-digital-marketing.gif)]">
            <Image
              src={Img}
