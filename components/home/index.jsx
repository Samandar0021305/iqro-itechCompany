    ...
    <div className="container mx-auto">
      <div className="sm:flex justify-center px-3 items-center text-center pb/-3 sm:py-16 ">
        <div className=" mb-15  sm:text-left sm:w-2/3 md:px-0">
          ...
          <h4 data-aos="fade-up-right" className=" text-2xl lg:text-3xl xl:text-5xl  mb-5 sm:mt-5 md:mb-5 lg:mb-8 font-medium">
            {t("home.header")}
          </h4>
          <h4 data-aos="fade-up-right" id="Direction" className=" text-[21px] sm:text-[24px] lg:text-3xl xl:text-5xl  font-normal  mb-10 text-blue">
            <TypedTex />
          </h4>
          <Button
            type="button"
